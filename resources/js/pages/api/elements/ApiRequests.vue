...
import GetInvoiceStatusRequest from '@/pages/api/elements/requests/GetInvoiceStatusRequest.vue'
...
<template>
    <div class="space-y-4">
        ...
        <GetInvoiceStatusRequest :api-key="props.apiKey" :api-base="props.apiBase" />
