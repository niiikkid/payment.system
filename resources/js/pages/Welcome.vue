...
<template>
    ...
    <div
        class="flex min-h-screen flex-col items-center bg-base-200 p-6 text-base-content lg:justify-center lg:p-8"
    >
        <header
        ...
        >
            ...
            >
                <div
                    class="flex-1 rounded-br-lg rounded-bl-lg bg-base-100 p-6 pb-12 text-[13px] leading-[20px] shadow-sm lg:rounded-tl-lg lg:rounded-br-none lg:p-20"
                >
                    ...
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        <li
                            class="relative flex items-center gap-4 py-2 before:absolute before:top-1/2 before:bottom-0 before:left-[0.4rem] before:border-l before:border-base-200"
                        >
                            <span
                                class="relative bg-base-100 py-1"
                            >
                                <span
                                    class="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-base-200 bg-base-100 shadow"
                                >
                                    <span
                                        class="h-1.5 w-1.5 rounded-full bg-base-300"
                                    />
                                </span>
                            </span>
                            <span>
                        ...
                        <li
                            class="relative flex items-center gap-4 py-2 before:absolute before:top-0 before:bottom-1/2 before:left-[0.4rem] before:border-l before:border-base-200"
                        >
                            <span
                                class="relative bg-base-100 py-1"
                            >
                ...
                <div
                    class="relative -mb-px aspect-335/376 w-full shrink-0 overflow-hidden rounded-t-lg bg-base-100 lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg"
                >
                    <svg
