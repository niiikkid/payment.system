    ...
    'api' => [
        ...
        'documentation' => [
            ...
            'endpoints' => [
                ...
                'list' => 'GET /invoices: получить список инвойсов с пагинацией.',
                ...
                'clients_get' => 'GET /clients: список клиентов.',
                'clients_post' => 'POST /clients: создать клиента.',
            ],
        ],
        'token' => [
            'title' => 'API Token',
        ...
        'requests' => [
            ...
            'list_description' => 'Список инвойсов с пагинацией. Поддерживает фильтры: status, currency, network, merchant_id, client_id, external_invoice_id, tag, search, has_callback, page, per_page.',
            ...
            'client_create_description' => 'Создаёт клиента по Client ID (external_id).',
            'tabs' => [
                'form' => 'Форма',
