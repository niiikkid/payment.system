...
return [
    ...
    'app' => [
        ...
        'settings' => [
            ...
            'max_integer' => 'Максимальная сумма должна быть целым числом.',
            'min_non_negative' => 'Минимальная сумма не может быть меньше нуля.',
            'max_non_negative' => 'Максимальная сумма не может быть меньше нуля.',
