...
return [
    ...
    'alpha_dash'             => 'O campo :attribute deve conter apenas letras, números, hifens e underlines.',
    ...
    'app' => [
        'invoice' => [
            'txid_required_for_paid' => 'TXID é obrigatório quando o status é pago.',
        ],
        'settings' => [
            'min_integer' => 'O valor mínimo deve ser um inteiro.',
            'max_integer' => 'O valor máximo deve ser um inteiro.',
            'min_non_negative' => 'O valor mínimo não pode ser menor que zero.',
            'max_non_negative' => 'O valor máximo não pode ser menor que zero.',
