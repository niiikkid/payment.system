...
return [
    ...
    'between'                => [
        'array'   => ':attribute 字段的条目数必须在 :min 到 :max 之间。',
    ...
    'required_with_all'      => '当存在 :values 时，:attribute 字段为必填项。',
    ...
    'size'                   => [
        'array'   => ':attribute 字段必须包含 :size 个条目。',
    ...
    'app' => [
        'invoice' => [
            'txid_required_for_paid' => '当状态为已支付时必须提供 TXID。',
        ],
        'settings' => [
            'min_integer' => '最小金额必须是整数值。',
            'max_integer' => '最大金额必须是整数值。',
            'min_non_negative' => '最小金额不能小于零。',
            'max_non_negative' => '最大金额不能小于零。',
