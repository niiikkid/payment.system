...
return [
    ...
    'any_of' => 'The :attribute field is not present in the list of allowed values.',
    ...
    'required_array_keys' => 'The :attribute field must contain keys: :values.',
    ...
    'app' => [
        ...
        'settings' => [
            ...
            'max_integer' => 'The maximum amount must be an integer.',
            'min_non_negative' => 'The minimum amount cannot be less than zero.',
            'max_non_negative' => 'The maximum amount cannot be less than zero.',
