    ...
    'api' => [
        ...
        'documentation' => [
            ...
            'endpoints' => [
                ...
                'list' => 'Returns list of invoices.',
                'get' => 'Returns full invoice details.',
                'status' => 'Returns current invoice status.',
                'public' => 'Returns public invoice data.',
                'qr' => 'Returns QR code for payment address.',
                'cancel' => 'Cancels active invoice.',
                'merchants' => 'Returns list of merchants.',
                'clients_get' => 'Returns list of clients.',
        ...
        'token' => [
            ...
            'regenerate_confirm_title' => 'Refresh API token',
            'regenerate_confirm_message' => 'Are you sure you want to refresh your API token? The old token will become invalid.',
        ...
        'requests' => [
            ...
            'list_description' => 'Returns list of invoices.',
