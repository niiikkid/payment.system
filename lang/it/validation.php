...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'Il :attribute fornito è presente in una violazione di dati. Scegli un :attribute diverso.',
    ],
    ...
    'app' => [
        'invoice' => [
            'txid_required_for_paid' => 'TXID è obbligatorio quando lo stato è pagato.',
        ],
        'settings' => [
            'min_integer' => 'L\'importo minimo deve essere un numero intero.',
            'max_integer' => 'L\'importo massimo deve essere un numero intero.',
            'min_non_negative' => 'L\'importo minimo non può essere negativo.',
            'max_non_negative' => 'L\'importo massimo non può essere negativo.',
