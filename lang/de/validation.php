...
return [
    ...
    'ascii'                  => 'Das Feld :attribute darf nur einbyte Alphanumerik und Symbole enthalten.',
    ...
    'prohibited_unless'      => 'Das Feld :attribute ist untersagt, außer :other befindet sich in :values.',
    ...
    'app' => [
        'invoice' => [
            'txid_required_for_paid' => 'TXID ist erforderlich, wenn der Status bezahlt ist.',
        ],
        'settings' => [
            'min_integer' => 'Der Mindestbetrag muss eine Ganzzahl sein.',
            'max_integer' => 'Der Höchstbetrag muss eine Ganzzahl sein.',
            'min_non_negative' => 'Der Mindestbetrag darf nicht kleiner als null sein.',
            'max_non_negative' => 'Der Höchstbetrag darf nicht kleiner als null sein.',
